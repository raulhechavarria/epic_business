...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:import href="custom_default_printscreen.xsl"/>
	<xsl:import href="custom_rml_printscreen.xsl"/>
	<xsl:template match="/">
	...
	<xsl:template name="stylesheet">
		<paraStyle name="title" fontName="Helvetica-Bold" fontSize="14" alignment="center"/>
		<paraStyle name="filters" fontName="Helvetica-Bold" fontSize="10" alignment="left"/>
		<paraStyle name="filters2" fontName="Helvetica" fontSize="10" alignment="left"/>
		<paraStyle name="groups" fontName="Helvetica-Bold" fontSize="10" alignment="left"/>
		<paraStyle name="groups2" fontName="Helvetica" fontSize="10" alignment="left"/>
	...
	<xsl:template match="config">
		...
		<blockTable style="products" colWidths="3.7cm,21cm" >
			<tr>
				<td>
					<para style="filters">
						<xsl:value-of select="filter_fields"/>
					</para>
				</td>
				<td>
					<para style="filters2">
						<xsl:value-of select="filter_content"/>
					</para>
				</td>
			</tr>
		</blockTable>
		...
		<blockTable style="products" colWidths="3.7cm,21cm">
			<tr>
				<td>
					<para style="groups">
						<xsl:value-of select="group_fields"/>
					</para>
				</td>
				<td>
					<para style="groups2">
						<xsl:value-of select="group_content"/>
					</para>
				</td>
			</tr>
		</blockTable>
